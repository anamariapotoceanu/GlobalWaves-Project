...
public final class User extends UserAbstract {
    ...
    @Getter
    private ArrayList<String> loadedSong;
    ...
    @Getter
    private List<Page> historyPageAux;

    @Getter
    private List<Page> historyPage;
    ...
    public void setArtistPage(final ArtistPage artistPage) {
    ...
    public void setHostPage(final HostPage hostPage) {
    ...
    public void setLoadedEpisode(final ArrayList<Episode> loadedEpisode) {
        this.loadedEpisode = loadedEpisode;
    }

    @Getter
    private ArrayList<Episode> loadedEpisode;

    @Getter
    private List<Artist> subscribedArtists = new ArrayList<>();

    public void setLastSongRecommendation(final Song lastSongRecommendation) {
    ...
    public void setLastPlaylistRecommendation(final Playlist lastPlaylistRecommendation) {
        this.lastPlaylistRecommendation = lastPlaylistRecommendation;
    }

    @Getter
    private Playlist lastPlaylistRecommendation;

    public void setTopAlbums(final ArrayList<Album> topAlbums) {
    ...
    public User(final String username, final int age, final String city) {
        ...
        subscribedArtists = new ArrayList<>();
        songRecommendations = new ArrayList<>();
        playlistRecommendations = new ArrayList<>();
        historyPage = new ArrayList<>();
        historyPageAux = new ArrayList<>();
        loadedSong = new ArrayList<>();
        loadedEpisode = new ArrayList<>();
    ...
    public String load() {
        ...
        if (searchBar.getLastSearchType().equals("podcast")) {
            loadedEpisode.add((Episode) player.getSource().getAudioFile());
        }
        loadedSong.add(player.getSource().getAudioFile().getName());
